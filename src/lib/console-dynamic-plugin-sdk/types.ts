 ...
 */
 export type ExtensionFlags = Partial<{
   ...
   */
  export type ExtensionDeclaration<T extends string, P extends {}> = Extension<
    P
  > & {
    type: T;
  };
  ...
  export type ResolvedCodeRefProperties<O extends {}> = {
    [K in keyof O]: O[K] extends CodeRef
      ? ExtractCodeRefType<O[K]>
      : ResolvedCodeRefProperties<O[K]>;
  };
